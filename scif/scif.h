/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     ADC Trigger
  * - <b>Project file</b>:     C:/Users/rober/OneDrive/Documentos/University/Mestrado/2 ano/Dissertação/ADC_Trigger.scp
  * - <b>Code prefix</b>:      -
  * - <b>Operating system</b>: TI-RTOS
  * - <b>Tool version</b>:     2.9.0.208
  * - <b>Tool patches</b>:     None
  * - <b>Target chip</b>:      CC2652RB1F, package QFN48 7x7 RGZ, revision E (2.1) or F (3.0)
  * - <b>Created</b>:          2025-12-03 15:43:23.609
  * - <b>Computer</b>:         LAPTOP-TE5P3AF9
  * - <b>User</b>:             rober
  *
  ...
  * - ADC Trigger:
  *     - <b>A: Input to internal ADC</b>: DIO23
  *     - <b>O: Row 0 of sensor matrix</b>: DIO25
  *     - <b>O: Row 1 of sensor matrix</b>: DIO26
  *     - <b>O: Row 2 of sensor matrix</b>: DIO27
  *     - <b>O: Col 0 of sensor matrix </b>: DIO28
  *     - <b>O: Col 1 of sensor matrix</b>: DIO29
  *     - <b>O: Col 2 of sensor matrix</b>: DIO30
  *     - <b>O: Debug Pin</b>: DIO0
  *
  *
  ...
  *
  *
  * \subsection section_task_desc_adc_trigger ADC Trigger
  * Sensor Controller Project Example
  *
  */
...
/// Target chip name
#define SCIF_TARGET_CHIP_NAME_CC2652RB1F
/// Target chip package
...
/// ADC Trigger: Task ID
#define SCIF_ADC_TRIGGER_TASK_ID 0


/// ADC Trigger: 
#define SCIF_ADC_TRIGGER_BUFFER_SIZE 1280
/// ADC Trigger I/O mapping: Input to internal ADC
#define SCIF_ADC_TRIGGER_DIO_A_ADC_INPUT 23
/// ADC Trigger I/O mapping: Row 0 of sensor matrix
#define SCIF_ADC_TRIGGER_DIO_O_ROW0 25
/// ADC Trigger I/O mapping: Row 1 of sensor matrix
#define SCIF_ADC_TRIGGER_DIO_O_ROW1 26
/// ADC Trigger I/O mapping: Row 2 of sensor matrix
#define SCIF_ADC_TRIGGER_DIO_O_ROW2 27
/// ADC Trigger I/O mapping: Col 0 of sensor matrix 
#define SCIF_ADC_TRIGGER_DIO_O_COL0 28
/// ADC Trigger I/O mapping: Col 1 of sensor matrix
#define SCIF_ADC_TRIGGER_DIO_O_COL1 29
/// ADC Trigger I/O mapping: Col 2 of sensor matrix
#define SCIF_ADC_TRIGGER_DIO_O_COL2 30
/// ADC Trigger I/O mapping: Debug Pin
#define SCIF_ADC_TRIGGER_DIO_O_DEBUG 0
...
/// ADC Trigger: Task configuration structure
typedef struct {
    uint16_t alertThr;   ///< ALERT interrupt generation threshold
    uint16_t frequency;  ///< 
    uint16_t matrixSize; ///< 
} SCIF_ADC_TRIGGER_CFG_T;


/// ADC Trigger: Task output data structure
typedef struct {
    uint16_t pSamples[1280]; ///< ADC sample buffer
} SCIF_ADC_TRIGGER_OUTPUT_T;


/// ADC Trigger: Task state structure
typedef struct {
    uint16_t adcEnabled;    ///< 
    uint16_t alertEnabled;  ///< Is ALERT interrupt generation enabled?s
    ...
    uint16_t timer0Running; ///< 
} SCIF_ADC_TRIGGER_STATE_T;


/// Sensor Controller task data (configuration, input buffer(s), output buffer(s) and internal state)
typedef struct {
    struct {
        SCIF_ADC_TRIGGER_CFG_T cfg;
        SCIF_ADC_TRIGGER_OUTPUT_T output;
        SCIF_ADC_TRIGGER_STATE_T state;
    } adcTrigger;
} SCIF_TASK_DATA_T;
